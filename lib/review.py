...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year            # validation in setter
        self.summary = summary      # validation in setter
        self.employee_id = employee_id  # validation in setter
    ...
    def employee_id(self, value):
        ...
        # ✅ Check if this employee actually exists in the DB
